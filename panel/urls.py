...
urlpatterns = [
    ...
    url(r'^(?P<pupil_id>[0-9]+)/edit/$', views.pupil_edit, name="pupil-edit"),
    ...
    url(r'^(?P<pupil_id>[0-9]+)/edit/parameter-add/$', views.parameter_create_from_pupil_edit, name="parameter-add-from-pupil-edit"),
